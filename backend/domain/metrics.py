...
from backend.core.config import FARK_TOLERANCE, PRESS_1, PRESS_2
...
def lab_summary(
    ...
    from backend.core.config import LAB_MEASURES
...
def lab_completeness(
    ...
    check was logged)."""
    from backend.core.config import LAB_CORE_FIELDS, LAB_MEASURES, LAB_POSA_FIELDS
